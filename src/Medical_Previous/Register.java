...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RegisterButton.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.white, java.awt.Color.blue, null, java.awt.Color.white));
        RegisterButton.setCursor(new java.awt.Cursor(java.awt.Cursor.SE_RESIZE_CURSOR));
        ...
        LoginButton.setCursor(new java.awt.Cursor(java.awt.Cursor.SE_RESIZE_CURSOR));
        ...
        if (user.length() > 0 && pass.length() > 0 && name.length() > 0) {
            if (pass.length() == Confirmpass.length()) {
                if (age >= 18) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Not allowed to go through");
                }
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Please fill Up everything");
        }
